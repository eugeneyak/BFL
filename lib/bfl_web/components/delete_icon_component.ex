defmodule BflWeb.DeleteIconComponent do
  use BflWeb, :live_component

  def render(assigns) do
    ~L"""
    <svg version="1.1" class="delete-btn__icon" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 486.4 486.4" style="enable-background:new 0 0 486.4 486.4;" xml:space="preserve">
      <g>
